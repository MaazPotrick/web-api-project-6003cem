...
app.listen(PORT, () => {
    ...
    console.log(`\n📋 Setup Required:`);
    console.log(`   1. Get Foursquare API key from: https://foursquare.com/developers/`);
    console.log(`   2. Add FOURSQUARE_API_KEY to your .env file`);
    console.log(`   3. Countries API (REST Countries) is free and requires no key`);
});
